...
## [0.2.0](https://github.com/aasseman/timeline-aggregation-protocol/compare/tap_aggregator-v0.1.0...tap_aggregator-v0.2.0) (2023-06-30)
...
* Added lib ([57c9ca2](https://github.com/aasseman/timeline-aggregation-protocol/commit/57c9ca29d7c111e41fd1f5c7c776684aeeb03c26))
* Added lib ([feaa54b](https://github.com/aasseman/timeline-aggregation-protocol/commit/feaa54b082f308abbf9f34060b14e2d535293885))
* added lib for tap_aggregator modules ([ba5840d](https://github.com/aasseman/timeline-aggregation-protocol/commit/ba5840d85bc567c4dcc01201bf8107b9936cbcd3))
...
* TAP Showcase: Added integration tests for `tap_manager` and `tap_aggregator`. ([975b3c7](https://github.com/aasseman/timeline-aggregation-protocol/commit/975b3c746b91c0cfe7a0dfc8a3361401bc70db28))
* TAP Showcase: Added integration tests for `tap_manager` and `tap_aggregator`. ([bcb6d82](https://github.com/aasseman/timeline-aggregation-protocol/commit/bcb6d820a0f257c61ad83cf739726c2646885ce9))
...
* **aggregator:** RAV and receipt timestamp checks ([faa3a8b](https://github.com/aasseman/timeline-aggregation-protocol/commit/faa3a8b62aea95947a39b5c8a6799199fd8f88e8))
...
* **aggregator:** warning codes ([67e8ff2](https://github.com/aasseman/timeline-aggregation-protocol/commit/67e8ff2b797e1efcf5d03d1452d055855b784d50))
